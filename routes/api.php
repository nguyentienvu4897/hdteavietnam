...
Route::group(['namespace'=>'Api','middleware'=>'auth:api'],function(){
	...
	Route::group(['prefix'=>'service','namspace'=>"service"], function(){
		...
		Route::group(['prefix'=>'type'], function() {
			Route::post('create', 'ServiceCategoryTypeController@create');
			Route::get('list', 'ServiceCategoryTypeController@list');
			Route::get('edit/{id}', 'ServiceCategoryTypeController@edit');
			Route::delete('delete/{id}', 'ServiceCategoryTypeController@delete');
		});
	});
	...
	Route::group(['prefix'=>'page_content'], function(){
		...
		Route::get('edit/{id}','PageContentController@edit');
		Route::get('delete/{id}','PageContentController@deletePageContent');
	});
