...
<div>
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-md-3">
                <h4 class="card-title">Sửa loại dịch vụ</h4>
                </div>
            ...
            <form class="forms-sample">
                ...
                <vs-select class="selectExample" v-model="objData.category_id" placeholder="Danh mục">
                <vs-select-item
                    :value="0"
                    text="Danh mục cha"
                />
                ...
                <!-- <div
                    v-if="submitted && !$v.objData.category_id.required"
                    class="noti-err"
...
methods: {
    ...
    // } else {
        ...
        .then(response => {
            ...
            this.$router.push({name: "listServiceCategoryType"});
        })
        .catch(error => {
            this.loadings(false);
            this.$errors("Sửa danh mục thất bại");
        });
    // }
    },
    listLang() {
    ...
    getServiceType() {
    this.loadings(true);
    this.detailServiceType(this.objData)
        .then(response => {
        this.loadings(false);
