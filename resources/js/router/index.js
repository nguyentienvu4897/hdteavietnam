...
let _routers = [
            ...
            {
                name: 'listServiceCategoryType',
                path: '/service/type',
                component: _import('service/type/list'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'editServiceCategoryType',
                path: '/service/type/edit/:id',
                component: _import('service/type/edit'),
                meta: {
                    requiresAuth: true,
                }
            },
