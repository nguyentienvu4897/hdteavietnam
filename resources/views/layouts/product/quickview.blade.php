...
@endphp
              ...
              <div class="form_product_content">
                 <div class="count_btn_style quantity_wanted_p">
                    ...
                    <div class="button_actions clearfix">
                       <button type="submit" class="qv_add_to_cart btn_cool btn btn_base fix_add_to_cart ajax_addtocart btn_add_cart btn-cart add_to_cart add_to_cart_detail"><span class="btn-content text_1">@lang('lang.addtocart')</span><span class="regular">@lang('lang.giaohang')</span></button>
                    </div>
                 </div>
              </div>
  ...
  {{-- <style>
    ...
    .quick-view-slide .swiper-slide {
      width: 25%;
      height: 100%;
      opacity: 0.4;
    }

    .quick-view-slide .swiper-slide-thumb-active {
      opacity: 1;
    }
