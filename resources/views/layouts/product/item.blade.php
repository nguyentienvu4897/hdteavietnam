...
@endphp
<form  class="wishItem variants product-box product-block-item" >
   ...
   <div class="product-action d-xl-flex d-none">
      <a title="Xem nhanh" href="javascript:;" data-handle="chuoi-nam-my" data-url={{route('quickview',['id'=>$product['id']])}} class="xem_nhanh btn-circle btn_view btn right-to quick-view hidden-xs hidden-sm">
