...
<form  class="wishItem variants product-box product-block-item" >
   ...
   <div class="product-action d-xl-flex d-none">
      ...
      @if($product['price']>0 && $product['discount']>=0 && $product['discount'] <100 )
      <button class="cart-button btn-buy firstb btn-cart button_35 left-to muangay btn-cart btn-views add_to_cart " data-id="{{$product['id']}}" data-url="{{route('addToCart')}}" title="Mua hàng">
