                    ...
                    <div class="swiper-slide">
                        <div class="content-service">
                            ...
                            <div class="title-service">
                                @lang('lang.hotline') 24/7
                            </div>
                            <div class="service-sumary">
                                @lang('lang.contact-with-us') 24h
                            </div>
                            </div>
                            <div class="service-left">
                            <img class="lazyload" src="data:image/png;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="{{url('frontend/images/service_1.svg')}}" alt="@lang('lang.hotline') 24/7"/>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="content-service">
                            ...
                            <div class="service-sumary">
                                @lang('lang.payment-security')
                            </div>
                            </div>
                            <div class="service-left">
                            <img class="lazyload" src="data:image/png;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="{{url('frontend/images/service_2.svg')}}" alt="@lang('lang.payment')"/>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="content-service">
                            ...
                            <div class="service-sumary">
                                @lang('lang.deliver-to-home')
                            </div>
                            </div>
                            <div class="service-left">
                            <img class="lazyload" src="data:image/png;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="{{url('frontend/images/service_3.svg')}}" alt="@lang('lang.delivery')"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="widget-ft">
                    <div class="blocklogo">
                        ...
                        <img width="270" height="75" src="{{$setting->logo}}" alt="{{languageName($setting->company)}}">					
                        </a>
                    </div>
                    ...
                    <div class="contactfooter">
                        <div class="flop mt">
                            ...
                            <div class="fright">
                                <a class="phone" href="tel:{{$setting->phone1}}">{{$setting->phone1}}</a>
                            </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="widget-ft link-list">
                            <h4 class="title-menu">
                            <span>@lang('lang.about-us')</span> 
                            </h4>
                            <div class="row content-menu">
                            <div class="col-xl-6 col-lg-6 col-12">
                                <ul class="list-menu">
                                    <li class="li_menu"><a href="{{route('home')}}">@lang('lang.home')</a></li>
                                    <li class="li_menu"><a href="{{route('aboutUs')}}">@lang('lang.aboutus')</a></li>
                                    <li class="li_menu"><a href="{{route('allProduct')}}">@lang('lang.products')</a></li>
                                </ul>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-12">
                                <ul class="list-menu">
                                    <li class="li_menu"><a href="{{route('allListBlog')}}">@lang('lang.blog')</a></li>
                                    <li class="li_menu"><a href="{{route('lienHe')}}">@lang('lang.contactus')</a></li>
                                </ul>
                            </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="widget-ft link-list">
                            ...
                            <span>@lang('lang.help-customer')</span>
                            </h4>
                            <div class="content-menu">
                            <ul class="list-menu">
                                @foreach ($helpCus as $item)
                                <li class="li_menu"><a href="{{route('pagecontent', ['slug'=>$item->slug])}}">{{languageName($item->title)}}</a></li>
                                @endforeach
                            </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-12 mail_footer">
                        <div class="mail_img">
                            <img class="lazyload" src="data:image/png;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="{{url('frontend/images/i-mail-f.svg')}}" alt="email"/>
                        </div>
                        <div class="mail_content">
                            ...
                            <div class="mail_2">
                            @lang('lang.receive-promotional-information')
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-12 mailchimp_footer">
                        <div class="form-footer">
                            ...
                            <div class="mail_footer subscribe">
                                <form id="mc-form" class="newsletter-form" data-toggle="validator" method="POST" action="{{route('postcontact')}}">
                                    @csrf
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-primary btn-lienhe" type="submit" aria-label="@lang('lang.send')" name="subscribe">@lang('lang.send')</button>
                                        </span>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <img class="lazyload" src="data:image/png;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="{{url('frontend/images/payment.png')}}" alt="payment"/>
                        </a>
                    </div>
                </div>
                </div>
